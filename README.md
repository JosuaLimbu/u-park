...
This web application is related to the [YOLOv5](https://github.com/JosuaLimbu/npr-with-ocr.git) repository which uses Number Plate Recognition with Optical Character Recognition technology.
